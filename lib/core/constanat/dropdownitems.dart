...
class DropDownItems{
  ...
  List<DropDownModel> floor = [
    ...
    DropDownModel(text: "الطابق4", value: "7"),
  ...
  List<DropDownModel> direction = [
    DropDownModel(text: "الغرب", value: "غرب"),
    DropDownModel(text: "الشرق", value: "شرق"),
    DropDownModel(text: " الشمال", value: "شمال"),
    DropDownModel(text: " الجنوب", value: "جنوب"),
  ...
  List<DropDownModel> condition = [
    ...
    DropDownModel(text: "جيد جدا", value: "جيد جدا"),
    DropDownModel(text: "ممتاز", value: "ممتاز"),
  ];
